...
State: `android_redesign_s1_scope_validation`
...
1. Validate S1.2 code and new category screenshots in hosted CI; inspect rendered images and commit only reviewed new references.
2. Complete S1.4 after regression checks; then begin S2 semantic tokens, shared rows and four-root navigation.
