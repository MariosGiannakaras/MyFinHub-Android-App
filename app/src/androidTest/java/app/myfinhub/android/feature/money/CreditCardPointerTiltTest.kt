...
class CreditCardPointerTiltTest {
    ...
    fun mouseMove_doesNotTiltWhenReducedMotionIsEnabled() {
        ...
        // Compare only the card's central surface. The pointer positions and transformed outer
        // edges/shadow live outside this region, so software-renderer cursor/edge noise cannot be
        // mistaken for pointer-position-dependent card tilt.
        val changedPixels = changedCentralPixelCount(topRight, bottomLeft)
        assertTrue(
