 ...
 *
 * One rounded 1.8dp stroke language is used across navigation, filters, finance semantics and
 * common categories. Feature screens depend on semantic names here, so Android never needs a
 * desktop-style icon picker and the whole visual vocabulary remains replaceable in one place.
 */
object MyFinHubIcons {
    ...
    val Activity by lazy {
        icon("MyFinHubActivity") { strokePath {
            moveTo(5f, 4f); lineTo(19f, 4f); lineTo(19f, 20f); lineTo(5f, 20f); close()
            moveTo(8f, 8f); lineTo(9f, 8f); moveTo(12f, 8f); lineTo(16f, 8f)
            moveTo(8f, 12f); lineTo(9f, 12f); moveTo(12f, 12f); lineTo(16f, 12f)
            moveTo(8f, 16f); lineTo(9f, 16f); moveTo(12f, 16f); lineTo(16f, 16f)
        } }
    }
    ...
    val Plan by lazy {
        icon("MyFinHubPlan") { strokePath {
            ...
            moveTo(5f, 9f); lineTo(19f, 9f); moveTo(8.5f, 14.5f); lineTo(11f, 17f); lineTo(16f, 12f)
        } }
    }

    val Insights by lazy {
        icon("MyFinHubInsights") { strokePath {
    ...
    val All by lazy { icon("MyFinHubAll") { strokePath { rect(4f, 4f, 6f, 6f); rect(14f, 4f, 6f, 6f); rect(4f, 14f, 6f, 6f); rect(14f, 14f, 6f, 6f) } } }
    val Income by lazy { icon("MyFinHubIncome") { strokePath { moveTo(12f, 4f); lineTo(12f, 17f); moveTo(7f, 12f); lineTo(12f, 17f); lineTo(17f, 12f); moveTo(5f, 20f); lineTo(19f, 20f) } } }
    val Expense by lazy { icon("MyFinHubExpense") { strokePath { moveTo(12f, 20f); lineTo(12f, 7f); moveTo(7f, 12f); lineTo(12f, 7f); lineTo(17f, 12f); moveTo(5f, 4f); lineTo(19f, 4f) } } }
    ...
    val Transfer by lazy { icon("MyFinHubTransfer") { strokePath { moveTo(4f, 8f); lineTo(18f, 8f); moveTo(14f, 4f); lineTo(18f, 8f); lineTo(14f, 12f); moveTo(20f, 16f); lineTo(6f, 16f); moveTo(10f, 12f); lineTo(6f, 16f); lineTo(10f, 20f) } } }
    val Attention by lazy { icon("MyFinHubAttention") { strokePath { moveTo(12f, 3f); lineTo(21f, 20f); lineTo(3f, 20f); close(); moveTo(12f, 9f); lineTo(12f, 14f); moveTo(12f, 17f); lineTo(12.1f, 17f) } } }
    val Filter by lazy { icon("MyFinHubFilter") { strokePath { moveTo(4f, 7f); lineTo(20f, 7f); circle(9f, 7f, 1.5f); moveTo(4f, 12f); lineTo(20f, 12f); circle(15f, 12f, 1.5f); moveTo(4f, 17f); lineTo(20f, 17f); circle(11f, 17f, 1.5f) } } }

    val Account by lazy {
        icon("MyFinHubAccount") { strokePath {
            moveTo(3f, 9f); lineTo(12f, 4f); lineTo(21f, 9f); close(); moveTo(5f, 10.5f); lineTo(19f, 10.5f)
            moveTo(7f, 10.5f); lineTo(7f, 18f); moveTo(12f, 10.5f); lineTo(12f, 18f); moveTo(17f, 10.5f); lineTo(17f, 18f)
            moveTo(4f, 18f); lineTo(20f, 18f); moveTo(3f, 21f); lineTo(21f, 21f)
        } }
    }
    ...
    val Goal by lazy { icon("MyFinHubGoal") { strokePath { circle(12f, 12f, 8f); circle(12f, 12f, 4f); circle(12f, 12f, 0.8f); moveTo(15f, 9f); lineTo(20f, 4f); moveTo(17f, 4f); lineTo(20f, 4f); lineTo(20f, 7f) } } }
...
private fun icon(name: String, autoMirror: Boolean = false, content: Builder.() -> Unit): ImageVector = Builder(
    name = name,
    defaultWidth = 24.dp,
    defaultHeight = 24.dp,
    viewportWidth = 24f,
